...
const createOnePublishingCompanyService = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const newPublishingCompany = yield (0, publishingCompany_1.createOnePublishingCompanyModel)({ data });
